  ...
  <section id="hero" className="bg-primary text-white py-5">
    <div className="container">
      <div className="d-flex flex-column flex-md-row align-items-center">
        <div
          className="mb-4 mb-md-0 d-flex justify-content-center justify-content-md-start"
        ...
        <div className="flex-grow-1 text-center text-md-start ps-md-5">
          <h1 className="display-5 font-title mb-3">
            <span className="visually-hidden">Mattéo Rouzioux – </span>N’achetez
            pas un nouveau PC tout de suite
          </h1>
